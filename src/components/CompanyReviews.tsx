...
export function CompanyReviews({
  ...
  if (!reviews.length) {
    return (
      <div className="rounded-2xl bg-white border border-dashed border-slate-200/60 p-12 text-center text-slate-400 text-xs font-semibold">
        Brak opinii klientów. Wizytówka nie posiada jeszcze żadnych ocen.
      </div>
    );
  }
    ...
    <div className="font-sans">
      ...
      <div className="space-y-4">
        {filteredReviews.length === 0 ? (
          <div className="text-center py-16 bg-white border border-dashed border-slate-200 rounded-xl text-slate-400 font-semibold text-xs">
